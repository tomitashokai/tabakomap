...
const SOURCES: Source[] = [
  ...
  },
  {
    title: '銘柄の小売定価',
    body:
      'JT の製品ページとフィリップモリスジャパンのプレスリリースで現物を確認できた銘柄には、' +
      '出典と確認日を添えて小売定価を表示しています。確認が取れていない価格は「参考」と明記しており、' +
      '銘柄名や規格が現行品と異なる場合があります。BAT ジャパンの銘柄は未確認です。' +
      '加熱式たばこは 2026年10月1日に改定が予定されています。',
    credit: '出典：JT 製品情報 / フィリップモリスジャパン プレスリリース',
